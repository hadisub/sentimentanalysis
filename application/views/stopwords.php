...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!--BUTTON TAMBAH -->
            <div class="btn-fixed">            
            <button a href="#modalstopwords" data-toggle ="modal" class="btn btn-circle btn-circle-lg btn-primary btn-add text-right"><i class="fa fa-plus fa-2x"></i></button>   
            </div>
      ...
      <input type="hidden" name="id_stopwords" id="id_stopwords" value="">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <i class = "fa fa-trash"></i>   Ya</button>
            </div>
          </div>
          </form>
      </div>
